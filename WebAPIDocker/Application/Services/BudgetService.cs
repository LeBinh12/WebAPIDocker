...
public class BudgetService : IBudgetService
{
    ...
    public BudgetService(IBudgetRepository repository, ITransactionRepository transactionRepository)
    {
    ...
    public async Task<Result<BudgetUsageDto?>> GetBudgetUsage(int userId, int budgetId)
    {
        ...
        var spent = await _transactionRepository.SumAmount(
            userId, 
            "EXPENSE", 
            b.start_date, 
            b.end_date, 
